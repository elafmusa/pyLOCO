...
def run_loco_request(request: LocoRunRequest, log_callback=None, cancel_callback=None) -> LocoRunResult:
    ...
    try:
        import at
        from pyLOCO.config import FitInitConfig, FixedParameters, RMConfig
        ...
        fit_cfg = FitInitConfig(**request.backend_mapping["FitInitConfig"])
        rm_cfg = RMConfig(**request.backend_mapping["RMConfig"])
